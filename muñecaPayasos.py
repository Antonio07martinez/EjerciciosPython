...
def Juguetes(payaso,muñeca):
    peso_payaso = payaso * 112
    peso_muñeca = muñeca * 75
    total_peso = peso_muñeca + peso_payaso
    print('\n*****************************************************************************************')
    print('Cantidad de payasos: '+str(payaso)+' KG: '+str(peso_payaso)+'\nCantidad de muñecas: '+str(muñeca)+' KG: '+str(peso_muñeca))
    print('Total KG de paquete: '+str(total_peso))
    print('*******************************************************************************************')

Juguetes(
    int(input('Cantidad de payasos a enviar: ')),
    int(input('Cantidad de muñecas a enviar: '))
)
